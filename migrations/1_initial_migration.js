const token = artifacts.require('../contracts/BOBEToken.sol')
const crowdsale = artifacts.require('../contracts/BOBECrowdsale.sol')
const setDefaultAccount = require('../scripts/setDefaultAccount.js')

module.exports = function(deployer, network, accounts) {
    const rate = new web3.BigNumber(5)
    const wallet = '0x3191c94d7e6c25a8c318a25f7c2d31c0934f682e'
